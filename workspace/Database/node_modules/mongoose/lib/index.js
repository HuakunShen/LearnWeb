 ...
 *
 * If you call `mongoose.models()` with twice the same name but a different schema,
 * you will get an `OverwriteModelError`. If you call `mongoose.models()` with
 ...
 *     mongoose.models('Actor', schema);
 *
 *     // create a new connection
 *     var conn = mongoose.createConnection(..);
 *
 *     // create Actor models
 *     var Actor = conn.models('Actor', schema);
 *     conn.models('Actor') === Actor; // true
 *     conn.models('Actor', schema) === Actor; // true, same schema
 *     conn.models('Actor', schema, 'actors') === Actor; // true, same schema and collection name
 *
 *     // This throws an `OverwriteModelError` because the schema is different.
 *     conn.models('Actor', new Schema({ name: String }));
 *
 ...
 * @return {Model} The models associated with `name`. Mongoose will create the models if it doesn't already exist.
 * @api public
 */
...
/**
 * Removes the models named `name` from the default connection, if it exists.
 ...
 * ####Example:
 *
 *     mongoose.models('User', new Schema({ name: String }));
 *     console.log(mongoose.models('User')); // Model object
 *     mongoose.deleteModel('User');
 *     console.log(mongoose.models('User')); // undefined
 *
 *     // Usually useful in a Mocha `afterEach()` hook
 *     afterEach(function() {
 *       mongoose.deleteModel(/.+/); // Delete every models
 *     });
 *
 * @api public
