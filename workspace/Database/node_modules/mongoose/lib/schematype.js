...
/**
 * Set the models that this path refers to. This is the option that [populate](https://mongoosejs.com/docs/populate.html)
 ...
 *     postSchema.path('user').ref('User'); // By models name
 *     postSchema.path('user').ref(User); // Can pass the models as well
 *
 ...
 *     });
 *
 * @param {String|Model|Function} ref either a models name, a [Model](https://mongoosejs.com/docs/models.html), or a function that returns a models name or models.
 * @return {SchemaType} this
 * @api public
 */
