 ...
 *     await mongoose.models('Person').findOne({ name: 'Axl Rose' }).session(s);
 *
 * @method session
 * @memberOf Query
 * @instance
 ...
 * ####Example:
 *
 *     await mongoose.models('Person').deleteOne({ name: 'Ned Stark' }).j(true);
 *
 * @method j
 * @memberOf Query
 * @instance
 ...
 *
 * @param {Model} [model] the models to cast to. If not set, defaults to `this.models`
 * @param {Object} [obj]
 * @return {Object}
 * @api public
 */
