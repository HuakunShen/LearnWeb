...
/**
 * Get/set the models that this aggregation will execute on.
 *
 * ####Example:
 *     const aggregate = MyModel.aggregate([{ $match: { answer: 42 } }]);
 *     aggregate.models() === MyModel; // true
 *
 *     // Change the models. There's rarely any reason to do this.
 *     aggregate.models(SomeOtherModel);
 *     aggregate.models() === SomeOtherModel; // true
 *
 * @param {Model} [model] the models to which the aggregate is to be bound
 * @return {Aggregate|Model} if models is passed, will return `this`, otherwise will return the models
 * @api public
 */
