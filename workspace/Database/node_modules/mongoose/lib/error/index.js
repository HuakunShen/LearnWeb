...
/**
 * Thrown when a models with the given name was already registered on the connection.
 * See [the FAQ about `OverwriteModelError`](/docs/faq.html#overwrite-models-error).
 *
 * @api public
 */
...
/**
 * Thrown when you try to access a models that has not been registered yet
 *
 * @api public
 */
