 ...
 * - `MissingSchemaError`: You tried to access a models with [`mongoose.models()`](api.html#mongoose_Mongoose-models) that was not defined
 ...
 * - `OverwriteModelError`: Thrown when you call [`mongoose.models()`](api.html#mongoose_Mongoose-models) to re-define a models that was already defined.
