 ...
 *
 *     const Model = mongoose.models('Test', schema);
 ...
 *     mongoose.models('Test', schema); // Prints 'name'
 *
 ...
 * @param {String} name
 * @param {Object} [options]
 * @param {String|Model} [options.ref] models name or models instance. Marks this as a [populate virtual](populate.html#populate-virtuals).
